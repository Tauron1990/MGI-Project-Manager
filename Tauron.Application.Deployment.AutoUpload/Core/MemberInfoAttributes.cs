...
namespace Tauron.Application.Deployment.AutoUpload.Core
{
    ...
    public abstract class MemberInfoAttribute : Attribute
    {
        ...
        public static void InvokeMembers<TAttribute>(object instance, string targetMember, [Catel.Fody.NotNull] params object[] parameters)
            where TAttribute : MemberInfoAttribute
        {
        ...
        public virtual string ProvideMemberName([Catel.Fody.NotNull] MemberInfo info) => MemberName ?? Argument.NotNull(info, nameof(info)).Name;
    }
}