...
namespace Tauron.MgiProjectManager.Identity
{
    public class DatabaseInitializer
    {
        ...
        public DatabaseInitializer(UserDbContext context, IAccountManager accountManager, ILogger<DatabaseInitializer> logger, PersistedGrantDbContext persistedGrantDbContext,
