...
namespace Neleus.DependencyInjection.Extensions
{
    public static class FactoryServiceCollectionExtensions
    {
        ...
        public static ServicesByNameBuilder<TService, EmptyMeta> AddByName<TService>(this IServiceCollection services)
        {
            return new ServicesByNameBuilder<TService, EmptyMeta>(services, new NameBuilderSettings());
        }
        ...
        /// <returns><see cref="ServicesByNameBuilder&lt;TService&gt;" /> which is used to build multiple named registrations</returns>
        public static ServicesByNameBuilder<TService, EmptyMeta> AddByName<TService>(this IServiceCollection services, NameBuilderSettings settings)
        {
            return new ServicesByNameBuilder<TService, EmptyMeta>(services, settings);
        }
        ...
        /// </summary>
        /// <returns><see cref="ServicesByNameBuilder&lt;TService&gt;" /> which is used to build multiple named registrations</returns>
        public static ServicesByNameBuilder<TService, TMeta> AddByName<TService, TMeta>(this IServiceCollection services)
        {
            return new ServicesByNameBuilder<TService, TMeta>(services, new NameBuilderSettings());
        }
        ...
        /// <summary>
        ///     Synonym of <see cref="GetServiceByName{TService}" />. It is recommended to use
        ///     <see cref="GetServiceByName{TService}" /> as a better naming convention.
        /// </summary>
