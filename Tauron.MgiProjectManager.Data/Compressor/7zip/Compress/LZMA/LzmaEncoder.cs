...
namespace Tauron.MgiProjectManager.Data.Compressor._7zip.Compress.LZMA
{
    public class Encoder : ICoder, ISetCoderProperties, IWriteCoderProperties
    {
        ...
        private readonly SevenZip.Compression.RangeCoder.Encoder _rangeEncoder = new SevenZip.Compression.RangeCoder.Encoder();
        ...
        private class LenEncoder
        {
            ...
            protected void Encode(SevenZip.Compression.RangeCoder.Encoder rangeEncoder, uint symbol, uint posState)
            {
