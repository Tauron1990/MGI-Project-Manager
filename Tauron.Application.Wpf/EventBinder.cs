...
namespace Tauron.Application.Wpf
{
    ...
    public static class EventBinder
    {
        ...
        public static void SetEvents(DependencyObject obj, string value) => Argument.NotNull(obj, nameof(obj)).SetValue(EventsProperty, Argument.NotNull(value, nameof(value)));
